...
export const fetchPage =createAsyncThunk("page/fetch" ,
    async (page,{getState}) => {
        ...
        const pageRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}`;
        const carCountRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=count`;
        const carModelbyMake = ` https://autodigg.com/ad-api/cars/list?body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=model`
        const carBodyTypeRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=body_type`;
        const carExtColourRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=exterior_color`;
        const carIntClolrRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=interior_color`;
        const carTransRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=transmission`;
        const carDriveTrainRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=drivetrain`;
        const carFuelTypeRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=fuel_type`;
        const carFeaturesRes = `https://autodigg.com/ad-api/cars/list?usedCar=false&body_type=${allState.carByBody}&model=${allState.carByModel}&car_type=${allState.carByType},Certified+pre-owned&make=${allState.carByMake}&page=${allState.page}&radius=${allState.carByRadius}&newCar=false&price_from=${allState.priceRange[0]}&price_to=${allState.priceRange[allState.priceRange.length-1]}&year_from=${allState.yearRange[0]}&year_to=${allState.yearRange[allState.yearRange.length-1]}&return=features`;
